...
public class FileServiceImpl implements FileService{
    ...
    @Override
    public boolean deleteFiles(List<Long> noList) throws Exception{
        ...
        // 2️⃣-2 : MyBatis 의 <foreach> 로 구분자 처리
        return fileMapper.deleteFileList(noList) > 0;
    }

    @Override
    public boolean deleteFilesById(List<String> idList) throws Exception{
