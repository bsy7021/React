        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              */}
              <input type="text" value={title} readOnly className={styles['form-input']} />
            </td>
          </tr>
          <tr>
            <th>작성자</th>
            <td>
              <input type="text" value={writer} readOnly className={styles['form-input']} />
            </td>
          </tr>
          <tr>
            <td colSpan={2}>
              <textarea cols={40} rows={10} value={content} readOnly className={styles['form-input']}></textarea>
            </td>
          </tr>
          <tr>
            <td colSpan={2}>
